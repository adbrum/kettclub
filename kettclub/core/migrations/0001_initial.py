# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-03-10 23:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('atleta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.Atleta', verbose_name='Nº do atleta')),
            ],
            options={
